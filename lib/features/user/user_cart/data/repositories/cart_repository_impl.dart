...
class CartRepositoryImpl implements CartRepository {
  ...
  FutureEither<void> createCart(String uid, CartEntity entity) async {
    try {
      ...
      return Left(FirebaseFailure(e.message ?? 'FirebaseFailure: addCart'));
    } catch (e) {
  ...
  FutureEither<CartEntity> getCart(String uid) async {
    try {
      ...
      return Left(FirebaseFailure(e.message ?? 'FirebaseFailure: getCart'));
    } catch (e) {
      return Left(DatabaseFailure(e.toString()));
    }
  }
  ...
  FutureEither<void> updateCart(String uid, CartEntity entity) async {
    try {
      ...
      return Left(FirebaseFailure(e.message ?? 'FirebaseFailure: updateCart'));
    } catch (e) {
      return Left(DatabaseFailure(e.toString()));
    }
  }
  ...
  FutureEither<void> deleteCart(String uid) async {
    try {
      return Right(await remoteDataSource.deleteCart(uid));
    } on FirebaseException catch (e) {
      return Left(FirebaseFailure(e.message ?? 'FirebaseFailure: deleteCart'));
    } catch (e) {
      return Left(DatabaseFailure(e.toString()));
    }
  }

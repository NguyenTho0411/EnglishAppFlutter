...
class UserRepositoryImpl implements UserRepository {
  ...
  FutureEither<void> removeAllFavourites({required String uid}) async {
    try {
      return Right(await userRemoteDataSource.removeAllFavourites(uid: uid));
    } on FirebaseException catch (e) {
      return Left(
  ...
  FutureEither<void> removeAllKnowns({required String uid}) async {
    try {
      return Right(await userRemoteDataSource.removeAllKnowns(uid: uid));
    } on FirebaseException catch (e) {
      return Left(
  ...
  FutureEither<List<String>> syncKnowns({
    ...
    try {
      ...
      return Left(FirebaseFailure(e.message ?? 'FirebaseFailure: syncKnowns'));
    } catch (e) {
      return Left(DatabaseFailure(e.toString()));
    }
  }
  ...
  FutureEither<void> addKnownWords({
    ...
    try {
      return Right(
        await userRemoteDataSource.addKnownWords(uid: uid, list: knowns),
      );
    } on FirebaseException catch (e) {
      return Left(
